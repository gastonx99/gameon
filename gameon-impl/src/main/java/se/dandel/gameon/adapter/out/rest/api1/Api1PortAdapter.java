...
public class Api1PortAdapter implements Api1Port {
    ...
    public Collection<Team> fetchTeams(Country country) {
        Collection<TeamDTO> dtos = invoker.invoke(ENVELOPE_TEAMS, PATH_SOCCER_TEAMS, Collections.singletonMap("country_id", country.getRemoteKey()));
    ...
    public Collection<Tournament> fetchLeagues(Country country) {
        ...
        Collection<LeagueDTO> dtos = invoker.invoke(ENVELOPE_LEAGUES, PATH_SOCCER_LEAGUES, Collections.singletonMap("country_id", country.getRemoteKey()));
